...
const DEFAULT_GLOW_COLOR = '0, 173, 181' // brand indigo (#00ADB5)
...
const BentoContext = createContext<BentoConfig>({
...
export function MagicBentoGrid({
  ...
  return (
    ...
    >
      ...
      <div ref={gridRef} className={cn('bento-section', className)}>
        {children}
      </div>
    </BentoContext.Provider>
  )
